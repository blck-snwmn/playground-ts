...
```shellscript
bunx create-remix@latest --template remix-run/remix/templates/spa
```
...
When you are ready to build a production version of your app, `bun run build` will generate your assets and an `index.html` for the SPA.
...
```shellscript
bunx sirv-cli build/client/ --single
```
