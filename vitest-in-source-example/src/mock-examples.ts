...
export class UserService {
    ...
    async createUser(id: string, name: string, email: string): Promise<{ success: boolean; message: string }> {
        // Validate email
    ...
    describe("Mock and Spy Examples", () => {
        describe("UserService with mocked dependencies", () => {
            ...
            it("should fail when user already exists", async () => {
                vi.mocked(mockEmail.validateEmail).mockReturnValue(true);
                vi.mocked(mockDb.findUser).mockResolvedValue({ id: "1", name: "Existing User" });
        ...
        describe("Function mocking and spying", () => {
            ...
            it("should mock custom logger", () => {
                ...
                expect(mockLogger).toHaveBeenCalledWith(expect.stringMatching(/^\[.*\] Custom log message$/));
            });
        });
