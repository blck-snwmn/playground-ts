...
test.describe("Input Component", () => {
	...
	test("should handle uncontrolled value with defaultValue", async ({
		mount,
	}) => {
	...
	test("should handle email input type", async ({ mount }) => {
		...
		await expect(component.getByTestId("input-element")).toHaveAttribute(
			"type",
			"email",
		);
	});
	...
	test("should apply outlined variant class", async ({ mount }) => {
		...
		await expect(component.getByTestId("input-element")).toHaveClass(
			/input-outlined/,
		);
	});
